DROP SCHEMA IF EXISTS `angularspringproject`;

CREATE SCHEMA `angularspringproject`;
USE `angularspringproject` ;


CREATE TABLE IF NOT EXISTS `angularspringproject`.`product_category` (
...
CREATE TABLE IF NOT EXISTS `angularspringproject`.`product` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
